...
const FacebookLoginComponent: React.FC<FacebookLoginProps> = (props) => {
  ...
  return (
    <FacebookLogin
      ...
      scope="instagram_basic,pages_show_list,instagram_content_publish,instagram_graph_user_media,instagram_graph_user_profile" // Requesting additional permissions
